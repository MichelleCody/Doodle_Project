...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button = (Button) findViewById(R.id.buttonRED);
        button.setOnClickListener(new View.OnClickListener(){
             public void onClick(View v){
                 Toast toast = Toast.makeText(getApplicationContext(), "Java Hookup button clicked" + ((Button)v).getText(), Toast.LENGTH_SHORT);
                 toast.show();
                 drawView = (DoodleView)findViewById(R.id.view);
                 drawView.changeColorRed();
             }
        });
